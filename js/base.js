export const elements = {
    ...
    feedbackAssistantCancelButton: document.querySelector(".feedback-assistant--btn__cancel"),
    feedbackAssistantSubmitButton: document.querySelector(".feedback-assistant--btn__open"),
    feedbackAssistantTextarea: document.querySelector(".feedback-assistant--textarea"),
    feedbackAssistantTopbarButton: document.querySelector(".menu-bar--icon__feedback"),
