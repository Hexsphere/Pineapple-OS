export const elements = {
  ...
  signupError: document.querySelector('.boot--login-error h3'),
  signupErrorDesc: document.querySelector('.boot--login-error p'),
  progressBarInner: document.querySelector('.boot--progress-bar__indicator')
